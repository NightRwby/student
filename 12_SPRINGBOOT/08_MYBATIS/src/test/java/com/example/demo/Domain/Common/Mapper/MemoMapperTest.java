...
class MemoMapperTest {
    ...
    @Test
    public void t1(){
        MemoDto dto = new MemoDto(1L,"내용","작성자", LocalDateTime.now(),null);
        memoMapper.insert(dto);
    }
    @Test
    public void t2(){
        MemoDto dto = new MemoDto(1L,"수정된내용","수정된작성자", null,null);
    ...
    @Test
    public void t4(){
        MemoDto dto = new MemoDto(null,"내용","작성자", LocalDateTime.now(),null);
        memoMapper.insert(dto);
...
//        list.forEach(System.out::println);
    ...
    @Test
    public void t7(){
        MemoDto dto1 = new MemoDto(2000L,"내용1","작성자1", LocalDateTime.now(),null);
        memoMapper.insertXML(dto1);
    }

    @Test
    public void t8(){
        MemoDto dto2 = new MemoDto(2000L,"내용2","작성자2", null,null);
