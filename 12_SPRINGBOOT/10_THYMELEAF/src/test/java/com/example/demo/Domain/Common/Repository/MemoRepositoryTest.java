...
class MemoRepositoryTest {
    ...
    public void post1000(){
        if(memoRepository.count()==0)
            for (int i=1;i<=1000;i++)
                memoRepository.save(new Memo(null,"TEST-"+i,"WRITER-"+i,LocalDateTime.now()));
    }
    ...
    public void t6(){
        ...
        // 페이지 메타 확인
        System.out.println("현재 페이지 번호 : "+(page.getNumber()+1));
        ...
        System.out.println("첫펀재 페이지인지 여부 : "+page.isFirst());
        ...
        List<Memo> list2 = nextPage.getContent();
